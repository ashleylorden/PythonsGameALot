import random, operator, signal, subprocess
...
# last round -- Add several song choices

song = "Congratulations, you are the Robot leader and we love you and we will do whatever you say, happy day!"
sing = ["say", "-v", "Cellos", song]

subprocess.call(sing)
